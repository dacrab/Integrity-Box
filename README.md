...
- **Are downloads verified?**  
  Yes, module files are verified at install time using hash verification.
...
- Option downloads recommended tools from their official release sources
...
- `Spoof Encryption :` spoofs device storage as encrypted to fool banking apps
- `Hide Recovery :` spoofs custom recovery folder to bypass root detection
- `Downloader :` the most easiest and trusted way to download modules which are recommended to use with IntegrityBox
...
- `Props :` Tells whether any lineageos prop exists or not
...
- `Integrity :` Current keybox integrity status
- `Expiry :` Expiry date of the applied fingerprint
#
</details>
